...
function calculateHealthFactors(stats, checkResults, incidents, alerts) {
  ...
  if (responseTimes.length > 0) {
    ...
    performanceScore = Math.max(
      0,
      Math.round(100 - (avgResponseTime / 2000) * 100)
    ); // Scale based on 2s max
  }
  ...
  const incidentScore = Math.max(
    0,
    Math.round(100 - totalIncidents * 5 - openIncidents * 10)
  );
  ...
  const alertScore = Math.max(
    0,
    Math.round(100 - totalAlerts * 3 - activeAlerts * 5)
  );
      ...
      switch (factor.type) {
        case 'uptime':
          recommendations.push({
            ...
            description:
              'Consider implementing redundancy, load balancing, or reviewing infrastructure stability.',
        ...
        case 'performance':
          recommendations.push({
            ...
            description:
              'Review API performance, database queries, or consider CDN implementation.',
        ...
        case 'incidents':
          recommendations.push({
            ...
            description:
              'Implement better monitoring, alerting, and preventive measures to reduce incidents.',
        ...
        case 'alerts':
          recommendations.push({
            ...
            description:
              'Review alert thresholds to reduce noise while maintaining effective monitoring.',
