      ...
      supported_behaviors: [
        {
          ...
          description: 'Service will be marked as degraded if provider shows degraded, down if provider shows down'
        },
        {
          value: 'always_degraded',
          label: 'Always Mark as Degraded',
          description: 'Service will always be marked as degraded when provider has any issues'
        },
        {
          value: 'always_down',
          label: 'Always Mark as Down',
          description: 'Service will always be marked as down when provider has any issues'
        }
      ]
    });
