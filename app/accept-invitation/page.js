      ...
      <Paper sx={{ p: 4 }}>
        ...
        {status === 'loading' ? (
          ...
          <Alert severity="info" sx={{ mb: 3 }}>
            You need to sign in to accept this invitation. We'll bring you back here after authentication.
          </Alert>
        ) : (
          ...
          <Box mt={4} p={2} bgcolor="grey.50" borderRadius={1}>
            ...
            <Typography variant="body2" color="text.secondary">
              {invitation.role === 'admin' ? (
                'As an admin, you can manage incidents, monitoring, team members, and organization settings.'
              ) : (
