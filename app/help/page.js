...
export default function HelpPage() {
  ...
  const helpSections = [
    ...
    },
    {
      ...
      icon: <IncidentIcon />,
      description: 'Learn how to create, manage, and resolve incidents effectively.',
      content: {
    ...
    },
    {
      ...
      icon: <MonitorIcon />,
      description: 'Set up monitoring checks to detect issues before they become incidents.',
      content: {
        overview: `Monitoring checks continuously watch your services and automatically create 
        incidents when problems are detected.`,
        checkTypes: {
          'HTTP/HTTPS': 'Monitor websites and APIs for uptime and response time',
    ...
    },
    {
      ...
      icon: <ScheduleIcon />,
      description: 'Manage team rotations and ensure 24/7 incident response coverage.',
      content: {
    ...
    },
    {
      ...
      icon: <SettingsIcon />,
      description: 'Configure automated escalation rules to ensure incidents get attention.',
      content: {
    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="h6" color="text.secondary" sx={{ mb: 3 }}>
          Everything you need to know about managing incidents, monitoring, and team response
        </Typography>
            ...
            <Box sx={{ pl: 2 }}>
              ...
              {section.content.severityLevels && (
                <Box sx={{ mb: 3 }}>
                  ...
                  {Object.entries(section.content.severityLevels).map(([level, description]) => (
                    <Alert severity={level === 'Critical' ? 'error' : level === 'High' ? 'warning' : 'info'} sx={{ mb: 1 }} key={level}>
              ...
              {section.content.checkTypes && (
                <Box sx={{ mb: 3 }}>
                  ...
                  {Object.entries(section.content.checkTypes).map(([type, description]) => (
              ...
              {section.content.rotationTypes && (
                <Box sx={{ mb: 3 }}>
                  ...
                  {Object.entries(section.content.rotationTypes).map(([type, description]) => (
                    <Alert severity="info" sx={{ mb: 1 }} key={type}>
                      <Typography variant="body2">
                        <strong>{type}:</strong> {description}
                      </Typography>
              ...
              {section.content.memberRoles && (
                <Box sx={{ mb: 3 }}>
                  ...
                  {Object.entries(section.content.memberRoles).map(([role, description]) => (
