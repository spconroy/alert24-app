...
export default function MonitoringPage() {
  ...
  const stats = {
    ...
    warning: monitoringChecks.filter(c => c.current_status === 'warning').length,
          ...
          {loading ? (
            ...
            <Box textAlign="center" py={6}>
              ...
              <Typography variant="body2" color="text.secondary" mb={3}>
                Add your first monitoring check to start tracking service health.
              </Typography>
              <Button
                component={Link}
                href="/monitoring/new"
