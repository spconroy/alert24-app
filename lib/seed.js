...
async function main() {
  ...
  await prisma.subscriptionPlans.createMany({
    data: [
      ...
      },
      {
        ...
        price_yearly: 499,
        features: {
          features: ['Up to 25 members', 'Priority support', 'Custom branding'],
        },
        max_members: 25,
        max_projects: 10,
        active: true,
      },
      {
        ...
        price_yearly: 1999,
        features: {
          features: ['Unlimited members', 'Dedicated support', 'White-label'],
        },
        max_members: 9999,
        max_projects: 9999,
        active: true,
  ...
  await prisma.organizationMembers.upsert({
    where: {
      organization_id_user_id: { organization_id: org.id, user_id: user.id },
    },
    update: {},
    create: {
