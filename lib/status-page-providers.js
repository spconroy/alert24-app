...
export const STATUS_PAGE_PROVIDERS = {
  ...
  aws: {
    ...
    // api_url: 'https://status.aws.amazon.com/api/v2/status.json', // AWS doesn't provide this API - use HTML scraping
    services: [
      {
        id: 'aws-ec2',
        name: 'Amazon EC2',
  ...
  gcp: {
    ...
    // api_url: 'https://status.cloud.google.com/api/v2/status.json', // GCP doesn't provide this API - use HTML scraping
    services: [
      {
    ...
    services: [
      {
        ...
        name: 'Git Operations',
        description:
          'Git cloning, pushing, fetching and all related operations',
        regions: ['global'],
      },
      {
  ...
  stripe: {
    ...
    // api_url: 'https://status.stripe.com/api/v2/status.json', // Stripe doesn't use standard API
    services: [
      {
        id: 'stripe-api',
        name: 'Stripe API',
